    ...
    if "centered" in folder_name:
        ...
        if os.path.isdir(folder_full_path):
            ...
            if largest_csv_file:
                ...
                # ### adding med_condition to the dataframe and delete 
                # df = pd.merge(df, med_condition_df, on=['group', 'patient', 'bundle'])
                # print(df.head())
                ...
                if constant_columns_df is None:
                    ...
                    extra_columns = ['name', 'med_condition', 'condition']
                ...
                # columns reordering
                column_final_order = ['group', 'patient', 'bundle', 'name', 'med_condition', 'condition'] 
