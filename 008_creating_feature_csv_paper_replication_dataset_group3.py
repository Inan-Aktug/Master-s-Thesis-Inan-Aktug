...
### group3 dataset
output_path = r'D:\00000_master_thesis_new\csv files\rf_features\paper_replication_dataset\filtered_for_group_3_updrs_25'

input_folder = r'D:\00000_master_thesis_new\csv files\group3 data\paper_replication_group3_filter_updrs_25\raw'
input_file = r'c1_v1_plus_duration_group3.csv'
...
df_centered.to_csv(os.path.join(r'D:\00000_master_thesis_new\csv files\group3 data\paper_replication_group3_filter_updrs_25\centered', centered_filename + '.csv'), index=False)
df_centered.to_excel(os.path.join(r'D:\00000_master_thesis_new\csv files\group3 data\paper_replication_group3_filter_updrs_25\centered', centered_filename + '.xlsx'), index=False)


df_centered_and_scaled.to_csv(os.path.join(r'D:\00000_master_thesis_new\csv files\group3 data\paper_replication_group3_filter_updrs_25\centered_and_min_max', centered_and_min_max_filename + '.csv'), index=False)
df_centered_and_scaled.to_excel(os.path.join(r'D:\00000_master_thesis_new\csv files\group3 data\paper_replication_group3_filter_updrs_25\centered_and_min_max', centered_and_min_max_filename + '.xlsx'), index=False) 
# sys.exit()
...
print(df.columns)
df_group2_info = df[['group', 'patient', 'bundle', 'group2', 'group3']]
print(df_group2_info)

# sys.exit()

# Merge df_rf_features with df based on 'group', 'patient', and 'bundle' columns
df_rf_features = pd.merge(df_rf_features, df[['group', 'patient', 'bundle', 'group2', 'group3']].drop_duplicates(),
                          on=['group', 'patient', 'bundle'], how='left')


column_order = ['group', 'patient', 'bundle', 'group2', 'group3']
